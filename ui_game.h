...
public:
    ...
    void setupUi(QWidget *game)
    {
        ...
        map->setGeometry(QRect(41, 0, 1691, 965));
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, other_actions);
        ...
        formLayout->setWidget(9, QFormLayout::LabelRole, build_station);
        ...
        formLayout->setWidget(10, QFormLayout::LabelRole, treat_disease);
        ...
        formLayout->setWidget(11, QFormLayout::LabelRole, discover_cure);

        skip = new QPushButton(formLayoutWidget);
        skip->setObjectName(QStringLiteral("skip"));
        skip->setMaximumSize(QSize(200, 50));
        skip->setFont(font1);

        formLayout->setWidget(12, QFormLayout::SpanningRole, skip);
        ...
        hand->setGeometry(QRect(0, 660, 201, 192));
        outbreaks = new QLabel(game);
        outbreaks->setObjectName(QStringLiteral("outbreaks"));
        outbreaks->setGeometry(QRect(230, 510, 51, 51));
        ...
        infection_rate->setGeometry(QRect(1080, 160, 51, 51));
        ...
        karachi->setGeometry(QRect(1120, 380, 31, 31));
        riyadh = new QPushButton(game);
        riyadh->setObjectName(QStringLiteral("riyadh"));
        riyadh->setGeometry(QRect(1030, 440, 31, 31));
        mumbai = new QPushButton(game);
        mumbai->setObjectName(QStringLiteral("mumbai"));
        mumbai->setGeometry(QRect(1130, 460, 31, 31));
        ...
        moscow = new QPushButton(game);
        moscow->setObjectName(QStringLiteral("moscow"));
        moscow->setGeometry(QRect(1030, 230, 31, 31));
        yellow = new QLabel(game);
        yellow->setObjectName(QStringLiteral("yellow"));
        yellow->setGeometry(QRect(620, 910, 51, 51));
        yellow->setStyleSheet(QStringLiteral("image: url(:/img/img/yellow_cure.png);"));
        red = new QLabel(game);
        red->setObjectName(QStringLiteral("red"));
        red->setGeometry(QRect(690, 910, 51, 51));
        red->setStyleSheet(QStringLiteral("image: url(:/img/img/red_cure.png);"));
        blue = new QLabel(game);
        blue->setObjectName(QStringLiteral("blue"));
        blue->setGeometry(QRect(760, 910, 51, 51));
        blue->setStyleSheet(QLatin1String("image: url(:/img/img/blue_cure.png);\n"
""));
        black = new QLabel(game);
        black->setObjectName(QStringLiteral("black"));
        black->setGeometry(QRect(820, 910, 51, 51));
        black->setStyleSheet(QStringLiteral("image: url(:/img/img/black_cure.png);"));
        city_widget = new QWidget(game);
        city_widget->setObjectName(QStringLiteral("city_widget"));
        city_widget->setGeometry(QRect(1570, 0, 350, 400));
        city_info = new QLabel(city_widget);
        city_info->setObjectName(QStringLiteral("city_info"));
        city_info->setGeometry(QRect(0, 0, 350, 400));
        city_title = new QLabel(city_widget);
        city_title->setObjectName(QStringLiteral("city_title"));
        city_title->setGeometry(QRect(10, 0, 300, 50));
        city_title->setFont(font1);
        player_widget = new QWidget(game);
        player_widget->setObjectName(QStringLiteral("player_widget"));
        player_widget->setGeometry(QRect(1570, 370, 350, 600));
        player_info = new QLabel(player_widget);
        player_info->setObjectName(QStringLiteral("player_info"));
        player_info->setGeometry(QRect(10, 50, 350, 600));
        player_info->setFont(font2);
        player_title = new QLabel(player_widget);
        player_title->setObjectName(QStringLiteral("player_title"));
        player_title->setGeometry(QRect(10, 0, 350, 50));
        player_title->setFont(font1);
        operation_e = new QLabel(game);
        operation_e->setObjectName(QStringLiteral("operation_e"));
        operation_e->setGeometry(QRect(410, 310, 21, 41));
        operation_e->setStyleSheet(QStringLiteral("image: url(:/img/img/blue_player.png);"));
        quarantine_e = new QLabel(game);
        quarantine_e->setObjectName(QStringLiteral("quarantine_e"));
        quarantine_e->setGeometry(QRect(410, 350, 21, 41));
        quarantine_e->setStyleSheet(QStringLiteral("image: url(:/img/img/green_player.png);"));
        scientist = new QLabel(game);
        scientist->setObjectName(QStringLiteral("scientist"));
        scientist->setGeometry(QRect(460, 350, 21, 41));
        scientist->setStyleSheet(QStringLiteral("image: url(:/img/img/red_player.png);"));
        medic = new QLabel(game);
        medic->setObjectName(QStringLiteral("medic"));
        medic->setGeometry(QRect(460, 310, 21, 41));
        medic->setStyleSheet(QStringLiteral("image: url(:/img/img/yellow_player.png);"));
        rs1 = new QLabel(game);
        rs1->setObjectName(QStringLiteral("rs1"));
        rs1->setGeometry(QRect(1520, 0, 51, 51));
        rs1->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        rs2 = new QLabel(game);
        rs2->setObjectName(QStringLiteral("rs2"));
        rs2->setGeometry(QRect(1460, 0, 51, 51));
        rs2->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        rs4 = new QLabel(game);
        rs4->setObjectName(QStringLiteral("rs4"));
        rs4->setGeometry(QRect(1520, 60, 51, 51));
        rs4->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        rs5 = new QLabel(game);
        rs5->setObjectName(QStringLiteral("rs5"));
        rs5->setGeometry(QRect(1460, 60, 51, 51));
        rs5->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        rs3 = new QLabel(game);
        rs3->setObjectName(QStringLiteral("rs3"));
        rs3->setGeometry(QRect(1410, 0, 51, 51));
        rs3->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        rs6 = new QLabel(game);
        rs6->setObjectName(QStringLiteral("rs6"));
        rs6->setGeometry(QRect(1410, 60, 51, 51));
        rs6->setStyleSheet(QStringLiteral("image: url(:/img/img/research_station.png);"));
        map->raise();
        exit_game->raise();
        show_actions->raise();
        show_hand->raise();
    ...
    void retranslateUi(QWidget *game)
    {
        ...
        skip->setText(QApplication::translate("game", "Skip", 0));
        ...
        moscow->setText(QString());
        yellow->setText(QString());
        red->setText(QString());
        blue->setText(QString());
        black->setText(QString());
        city_info->setText(QString());
        city_title->setText(QApplication::translate("game", "City Info", 0));
        player_info->setText(QString());
        player_title->setText(QApplication::translate("game", "Player Info", 0));
        operation_e->setText(QString());
        quarantine_e->setText(QString());
        scientist->setText(QString());
        medic->setText(QString());
        rs1->setText(QString());
        rs2->setText(QString());
        rs4->setText(QString());
        rs5->setText(QString());
